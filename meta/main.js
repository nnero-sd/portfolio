...
function renderScatterPlot(data, commits) {
  ...
  // Assign to module-level so isCommitSelected can use them
  xScale = d3
    .scaleTime()
  ...
  // Brush must be added before dots so overlay doesn't block mouse events
  ...
  // Raise dots above the brush overlay so hover/tooltips still work
